    ...
    <div class="glowny">
        ...
        <?php
            if(isset($_POST['model'])) {
                ...
                $sql = "SELECT nazwa, cena, kolor, kod_produktu, material, nazwa_pliku FROM buty JOIN produkty USING(model) WHERE model = '$model';";
                ...
                echo "<div class='buty'>";
                    ...
                    $cena = $row['cena'] * $liczbaPar;
                    echo "<p>cena za $liczbaPar par: $cena zł</p>";
